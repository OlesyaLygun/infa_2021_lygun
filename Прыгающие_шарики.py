...
def click(event):
    #Обрабатывает клик. Если игрок попадает в шар, то количество очков увеличивается + скорость нажатого шарика увеличивается на количество
    #очков. После скорость равное 20, шар лопается
    global point
