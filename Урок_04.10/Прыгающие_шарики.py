...
def balls_movements():
    ...
    if balls_left > 0 and point <= 60:
        ...
        canv.delete(ALL)
        for i in range(100):
            colors = choice(['aqua', 'green', 'maroon', 'yellow',
